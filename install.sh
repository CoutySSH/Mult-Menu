...
wget https://raw.githubusercontent.com/CoutySSH/imagens-png/main/gestorssh.zip > /dev/null 2>&1
...
cd /bin || exit
wget https://raw.githubusercontent.com/CoutySSH/imagens-png/main/userteste.sh
wget https://raw.githubusercontent.com/CoutySSH/imagens-png/main/autobackup.sh
...
clear
sleep 1
echo -e "\033[1;32m PAINEL WWEB INSTALADO COM SUCESSO!"
echo ""
echo -e "                 \033[1;31mBy @Couty_SSH\033[1;36m"
echo ""
