...
IP=$(wget -qO- ipv4.icanhazip.com)
clear
echo -e "\E[44;1;37m    ATUALIZANDO O PAINEL WEB      \E[0m"
echo ""
...
rm -rf * > /dev/null 2>&1
wget https://raw.githubusercontent.com/CoutySSH/imagens-png/main/gestorssharm18.zip > /dev/null 2>&1
sleep 1
...
echo -e "   CoutySSH" | figlet
echo ""
echo -e "\033[1;36m PAINELWEB DIGITE ESSE IP NO NAVEGADOR:\033[1;37m http://$IP/\033[0m"
echo ""
